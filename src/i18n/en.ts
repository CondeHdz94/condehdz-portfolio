...
export const en: Translations = {
  ...
  cases: {
    ...
    sistel: {
      ...
      scene: {
        captions: [
          { kicker: '01 · Arrives',     text: 'A PowerPoint script.' },
          { kicker: '02 · Reality',     text: 'Flat. Dense. Soulless.' },
          { kicker: '03 · Transform',   text: 'Articulate Storyline 360.' },
          { kicker: '04 · Build',       text: 'Layers, triggers, pacing.' },
          { kicker: '05 · Publish',     text: 'Hello, Acme Corp.' },
          { kicker: '06 · Interactive', text: 'Quiz · Drag · Scenarios · Certificate.' },
          { kicker: 'Sistel',           text: 'From script to experience.' },
        ],
        ppt: {
          title: 'MODULE 1 — WELCOME TO ACME CORP',
          bullets: [
            'Acme Corp was founded in 1985 with the goal of becoming a logistics leader.',
            'We have over 5,000 employees across 12 countries in Latin America.',
            'Our values are: integrity, innovation, customer service, and teamwork.',
            'The onboarding process takes an estimated 2 hours and 30 minutes.',
            'To pass, you must complete the assessment with a minimum score of 80%.',
          ],
          confidential: 'ACME CORP — CONFIDENTIAL',
        },
        welcome: {
          eyebrow:   'Welcome',
          titlePre:  'Welcome to',
          body:      'An interactive experience designed to guide you through your first day.',
          cta:       'Start →',
        ...
        published: {
          ...
          eyebrow:   'Welcome',
          titlePre:  'Welcome to',
          subtitle:  'An interactive experience for your onboarding.',
          cta:       'Start onboarding →',
          secondary: 'View content',
          bubble:    "Hi! I'm Sofía, your guide.",
        },
        quiz: {
          header:         'Quiz · Question 3 / 8',
          tag:            'Interactive',
          qPre:           'What is ',
          qEm:            'one',
          qPost:          " of Acme Corp's values?",
          options:        ['Innovation', 'Speed', 'Exclusivity', 'Secrecy'],
          feedbackStrong: 'Correct!',
          feedback:       "Innovation is one of Acme's four pillars.",
        },
        drag: {
          header:      'Drag and drop',
          tag:         'Drag & Drop',
          prompt:      'Drag each value to its definition.',
          values:      ['Integrity', 'Innovation', 'Service'],
          definitions: [
            'Always seek new ways to do things better.',
            'Act with consistency between what we say and do.',
            "Anticipate the customer's needs.",
          ],
        },
        branch: {
          header:       'Scenario · Decision 2',
          tag:          'Branching',
          promptStrong: 'An angry customer calls.',
          prompt:       "It's your first day. What do you do?",
          options: [
            'I listen calmly and take notes.',
            'I tell them to call back tomorrow.',
            'I transfer the call right away.',
          ],
          pathLabel:  'Path →',
          pathResult: 'Successful resolution',
        },
        cert: {
          ...
          titlePre:   'Onboarding',
          titleEm:    'complete',
          body:       "Congratulations. You've completed the module with an outstanding score.",
          statLabels: ['Participant', 'Duration', 'Score'],
